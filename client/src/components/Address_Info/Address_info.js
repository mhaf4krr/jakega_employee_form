        ...
        <Form>
          ...
          <Form.Group widths="equal">
            <Form.Field
              ...
              value={form["present_address"]["first_name"]}
            />
            <Form.Field
              control={Form.Input}
          ...
          <Form.Field
              ...
              onChange={(e, { value }) => {
                handleFormFill("address_information", "district", value,"present_address");
              }}
          ...
          <Form.Group widths="equal">
            <Form.Field
              ...
              value={form["permanent_address"]["first_name"]}
            />
            <Form.Field
              control={Form.Input}
              label="Locality / Street"
          ...
          <Form.Field
              ...
              placeholder={form["permanent_address"]["district"] || "District"}
              onChange={(e, { value }) => {
                handleFormFill("address_information", "district", value,"permanent_address");
              }}
              searchInput={{ id: "form-select-control-district" }}
            />
             <Form.Field
          ...
          <div className={styles["sub_form"]}>
              ...
              <p>
                  Please mention original native place, if the family has migrated after 01.01.1990
              </p>
              </div>
          ...
          <Form.Group widths="equal">
            <Form.Field
              ...
              value={form["original_native_address"]["first_name"]}
            />
            <Form.Field
              control={Form.Input}
              label="Locality / Street"
          ...
          <Form.Field
              ...
              placeholder={form["original_native_address"]["district"] || "District"}
              onChange={(e, { value }) => {
                handleFormFill("address_information", "district", value,"original_native_address");
              }}
              searchInput={{ id: "form-select-control-district" }}
            />
             <Form.Field
          ...
          <div className={styles["btn_wrapper"]}>
            <Button.Group>
              <Button size="medium" color="yellow" onClick={e=>{
                  decrementStep()
              }}>
                BACK: 2. PERSONAL INFO
              </Button>
              <Button.Or />
              <Button size="medium" positive onClick={e=>{
                  e.preventDefault()
